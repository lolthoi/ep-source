...
BEGIN
	...
	BEGIN TRY
		...
		*/
		...
		IF NOT EXISTS(SELECT 1 From INFORMATION_SCHEMA.COLUMNS Where TABLE_NAME = 'Project' AND COLUMN_NAME = 'StartDate' AND COLUMN_NAME = 'EndDate')
		BEGIN
			ALTER TABLE [dbo].[Project] Add [StartDate] DATETIME not null default GETDATE()
			ALTER TABLE [dbo].[Project] Add [EndDate] DATETIME null 		
		END
