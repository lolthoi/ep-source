...
DECLARE @OLD_VERSION VARCHAR(10) = '1.0.0.9'
DECLARE @NEW_VERSION VARCHAR(10) = '1.0.1.0'
...
BEGIN
	...
	BEGIN TRY
		...
		*/
		...
		IF EXISTS(SELECT 1 From INFORMATION_SCHEMA.COLUMNS Where TABLE_NAME = 'TSRecord')
		BEGIN				
			ALTER TABLE [dbo].[TSRecord] ALTER COLUMN [Name] [nvarchar](200) NOT NULL
			ALTER TABLE [dbo].[TSRecord] ALTER COLUMN [BacklogId] [nchar](50)
			ALTER TABLE [dbo].[TSRecord] ALTER COLUMN [TaskId] [nchar](50)		
		END
