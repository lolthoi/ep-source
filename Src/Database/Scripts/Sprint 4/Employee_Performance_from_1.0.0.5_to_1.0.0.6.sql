...
DECLARE @OLD_VERSION VARCHAR(10) = '1.0.0.5'
DECLARE @NEW_VERSION VARCHAR(10) = '1.0.0.6'
...
BEGIN
	...
	BEGIN TRY
		...
		*/
		...
		INSERT INTO [dbo].[CriteriaTypeStore]
			(Id, Name, Description, OrderNo, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate, DeletedBy, DeletedDate)
		 select c.Id, c.Name, c.Description, c.OrderNo, c.CreatedBy, c.CreatedDate, c.ModifiedBy, c.ModifiedDate, c.DeletedBy, c.DeletedDate 
		 from [dbo].[CriteriaType] c

 
		 INSERT INTO [dbo].[CriteriaStore]
			(Id, CriteriaTypeId, Name, Description, OrderNo, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate, DeletedBy, DeletedDate)
		 select c.Id, c.CriteriaTypeId, c.Name, c.Description, c.OrderNo, c.CreatedBy, c.CreatedDate, c.ModifiedBy, c.ModifiedDate, c.DeletedBy, c.DeletedDate
		 from [dbo].[Criteria] c
